...
class BookControllerRestAssuredTest {
    ...
    void shouldAddBook() {
        // given
        BookDto newBook = new BookDto("Tytuł", "Autor");

        // when
        Mockito.when(bookService.addBook(Mockito.any(BookDto.class)))
                .thenReturn(new BookDto("Tytuł", "Autor"));
        ...
        given()
                ...
                .body("title", Matchers.equalTo("Tytuł"))
                .body("author", Matchers.equalTo("Autor"));
    }
}